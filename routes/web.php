...
Route::get('/edit_post',[App\Http\Controllers\BlogController::class, 'edit'])->name('edit_post');
...
// Portfolio items
Route::post('/edit_item',[App\Http\Controllers\BlogController::class, 'edit'])->name('edit_post');
